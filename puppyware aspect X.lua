	...
	if PuppySettings.SilentAimSettings.PingPred2 and not PuppySettings.SilentAimSettings.PingPred1 and PuppySettings.SilentAim.Enabled then
	   ...
	   elseif ping < 40 then
		   ...
		   PredictionValue = 0.1256
                    ...
                    PredictionValue = 0.16537

                elseif ping < 270 then

                    PredictionValue = 0.195566

                elseif ping < 260 then

                    PredictionValue = 0.175566

                elseif ping < 250 then

                    PredictionValue = 0.1651

                elseif ping < 240 then

                    PredictionValue = 0.16780

                elseif ping < 230 then

                    PredictionValue = 0.15692

                elseif ping < 220 then

                    PredictionValue = 0.165566
